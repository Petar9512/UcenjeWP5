...
namespace UcenjeCS
{
    internal class CTabliceNeparParDL
    {

        public static void NeparniParniDLC(int x, int y)
        {
            int z = x * y;
            int min = x > y ? y : x;
            int max = x > y ? x : y;
        ...
        public static void NeparniParniDLAC(int x, int y)
        {
            int z = x * y;
            int min = x > y ? y : x;
            int max = x > y ? x : y;
        ...
        public static void NeparniParniDLCos(int x, int y)
        {
            int z = 1;
            int min = x > y ? y : x;
            int max = x > y ? x : y;
        ...
        public static void NeparniParniDLACos(int x, int y)
        {
            int z = 1;
            int min = x > y ? y : x;
            int max = x > y ? x : y;
