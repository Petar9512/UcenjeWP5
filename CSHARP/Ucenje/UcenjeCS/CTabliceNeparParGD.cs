...
namespace UcenjeCS
{
    internal class CTabliceNeparParGD
    {

        public static void NeparniParniGDC(int x, int y)
        {
            int z = x * y;
            int min = x > y ? y : x;
            int max = x > y ? x : y;
        ...
        public static void NeparniParniGDAC(int x, int y)
        {
            int z = x * y;
            int min = x > y ? y : x;
            int max = x > y ? x : y;
        ...
        public static void NeparniParniGDCos(int x, int y)
        {
            int z = 1;
            int min = x > y ? y : x;
            int max = x > y ? x : y;
        ...
        public static void NeparniParniGDACos(int x, int y)
        {
            int z = 1;
            int min = x > y ? y : x;
            int max = x > y ? x : y;
